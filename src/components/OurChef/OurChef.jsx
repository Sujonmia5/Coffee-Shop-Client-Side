    ...
    return (
        <div className='max-w-[1200px] p-5 mx-auto'>
            ...
            <div className='my-5 grid grid-cols-3 gap-4'>
                <div className='max-w-[520px] max-h-[476px] flex flex-col justify-end px-7 py-9 border rounded-lg chef_card'>
                    <div className='relative mb-5 flex-1'>
                        ...
                        <ul className='absolute space-y-3 top-16 right-0 social_chef'>
                            <li className='w-10 h-10 flex justify-center items-center bg-white hover:bg-primary hover:text-white transition-all rounded'>
                                <a href="#">
                                    <FaFacebookF />
                                </a>
                            </li>
